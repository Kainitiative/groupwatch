...
import AnglingClubLanding from "@/pages/auth/landing/AnglingClubLanding";

type InviteState =
  | { status: "loading" }
  | { status: "valid"; groupName: string; contactFirstName: string; groupType: string }
...
export default function JoinInvite() {
  ...
  if (invite.groupType === "angling_club") {
    return (
      <AnglingClubLanding
        token={token}
